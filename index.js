...
app.post('/api/translate', async (req, res) => {
  ...
  if (!apiKey) {
    ...
    // Gửi lỗi dưới dạng text vì client sẽ xử lý stream
  ...
  // **** THAY ĐỔI #1: Sử dụng endpoint `:streamGenerateContent` ****
  ...
  try {
    ...
    // **** THAY ĐỔI #2: Thiết lập header và chuyển tiếp (pipe) luồng dữ liệu ****
